<div class="header">
    ...
    <div class="pull-right btn-group">
        <?php echo xform_anchor($CI->_get_uri('add'), l('Tambah Data'), 'class="btn"') ?>
    </div>
...
<div class="grid-top">
    <div class="pull-left btn-group">
        <?php echo xform_anchor($CI->_get_uri('trash'), l('Hapus Data'), 'class="btn btn-danger mass-action"') ?>
        <?php //if (isset($CI->CAN_DELETE) && $CI->CAN_DELETE): ?>
        <?php //echo xform_anchor($CI->_get_uri('delete'), l('Hapus'), 'class="btn btn-danger mass-action"') ?>
        <?php //endif ?>
    </div>
