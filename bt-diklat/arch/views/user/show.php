...
<?php endif ?>
<?php $title = l( (empty($id) ? 'Tambah %s' : 'Ubah %s'), array(humanize(get_class($CI))) ) ?>
...
<form action="<?php echo current_url() ?>" method="post" class="ajaxform">
    <fieldset>
        ...
        <div>
            <label class="mandatory"><?php echo l('Nama Depan') ?></label>
            <input type="text" value="<?php echo set_value('first_name') ?>" name="first_name"  placeholder="<?php echo l('Nama Depan') ?>" />
        </div>
        <div>
            <label class="mandatory"><?php echo l('Nama Belakang') ?></label>
            <input type="text" value="<?php echo set_value('last_name') ?>" name="last_name"  placeholder="<?php echo l('Nama Belakang') ?>" />
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" value="<?php echo set_value('phone') ?>" name="phone" placeholder="Telepon">
        </div>
        <div>
